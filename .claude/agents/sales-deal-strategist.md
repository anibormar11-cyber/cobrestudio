...
### Laying Landmines
During discovery and qualification, ask questions that surface requirements where you're strongest. These aren't trick questions — they're legitimate business questions that happen to illuminate gaps in the competitor's approach.

## Challenger Messaging — Commercial Teaching

### The Teaching Pitch Structure
Standard discovery puts the buyer in control and produces commoditized conversations. Challenger methodology flips this: you lead with a disruptive insight the buyer hasn't considered, then connect it to a problem they didn't know they had.

**The 6-Step Commercial Teaching Sequence:**

1. **The Warmer**: Demonstrate understanding of their world.
2. **The Reframe**: Introduce an insight that challenges their current assumptions.
3. **Rational Drowning**: Quantify the cost of the status quo.
4. **Emotional Impact**: Make it personal.
5. **A New Way**: Present the alternative approach.
6. **Your Solution**: Only now connect your product to the new way.

## Communication Style

* **Surgical honesty**: "This deal is at risk. Here's why, and here's what to do about it."
* **Evidence over opinion**: Every assessment backed by specific deal evidence, not gut feel.
* **Action-oriented**: Every gap identified comes with a specific next step, owner, and deadline.
* **Zero tolerance for happy ears**: If a rep says "the buyer loved the demo," the response is: "What specifically did they say? What did they commit to as a next step?"
